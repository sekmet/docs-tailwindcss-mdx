...
export default function Layout(frontMatter) {
    ...
    return ({children: content}) => {
        const {title, description, docSearchVersion, featureVersion, features, titleBorder, hideTableOfContents} = frontMatter;
        ...
        return (
            <Fragment>
              <Head>
                ...
                <title>Tailwind CSS - A Utility-First CSS Framework for Rapidly Building Custom Designs</title>
                <link async rel="stylesheet" href="https://cdn.jsdelivr.net/docsearch.js/2/docsearch.min.css" />
              </Head>
            <div>
              <DocSearch version={docSearchVersion}/>
              <div id="header">
                          ...
                          <div className="flex flex-grow lg:w-3/4 xl:w-4/5">
                            ...
                            <div className="w-full lg:px-6 lg:w-3/4 xl:px-12">
                              <div className="relative">
                                <input id="docsearch" className="transition-colors duration-100 ease-in-out bg-white shadow-md focus:outline-0 border border-transparent placeholder-gray-600 rounded-lg py-2 pr-4 pl-10 block w-full appearance-none leading-normal" type="text" placeholder="Search the docs (Press &quot;/&quot; to focus)"/>
                                <div className="pointer-events-none absolute inset-y-0 left-0 pl-4 flex items-center">
                                  <svg className="fill-current pointer-events-none text-gray-600 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.9 14.32a8 8 0 1 1 1.41-1.41l5.35 5.33-1.42 1.42-5.33-5.34zM8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12z"/></svg>
                                </div>
                              </div>
                            </div>


                            <button type="button" id="sidebar-open" className="text-gray-500 focus:outline-none focus:text-gray-700 flex px-6 items-center lg:hidden">
                              <svg className="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                            </button>


                            <button type="button" id="sidebar-close" className="text-gray-500 focus:outline-none focus:text-gray-700 hidden flex px-6 items-center lg:hidden">
                              <svg className="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 8.586L2.929 1.515 1.515 2.929 8.586 10l-7.071 7.071 1.414 1.414L10 11.414l7.071 7.071 1.414-1.414L11.414 10l7.071-7.071-1.414-1.414L10 8.586z"/></svg>
                            </button>

                            {/* Links section */}
                            <div className="hidden lg:flex lg:items-center lg:justify-between xl:w-1/4 px-6">
                              <div className="relative mr-4">
                                <select data-version-switcher className="appearance-none block bg-transparent pl-2 pr-8 py-1 text-gray-500 font-medium text-base focus:outline-none focus:text-gray-800">
                                  <option value="v1">v{version}</option>
                  ...
                  <div className="w-full max-w-screen-xl relative mx-auto px-6 pt-16 pb-40 md:pb-24">
                    <div className="xl:flex -mx-6">
                      <div className="px-6 text-left md:text-center xl:text-left max-w-2xl md:max-w-3xl mx-auto">
                        <h1 className="text-3xl tracking-tight sm:text-4xl md:text-5xl xl:text-4xl font-medium leading-tight">A utility-first CSS framework for <span className="sm:block text-teal-500 font-medium">rapidly building custom designs.</span></h1>
                        ...
                        <div className="flex mt-6 justify-start md:justify-center xl:justify-start">
                          <a href="/docs/installation" className="rounded-lg px-4 md:px-5 xl:px-4 py-3 md:py-4 xl:py-3 bg-teal-500 hover:bg-teal-600 md:text-lg xl:text-base text-white font-semibold leading-tight shadow-md">Get Started</a>
                          <a href="#what-is-tailwind" className="ml-4 rounded-lg px-4 md:px-5 xl:px-4 py-3 md:py-4 xl:py-3 bg-white hover:bg-gray-200 md:text-lg xl:text-base text-gray-800 font-semibold leading-tight shadow-md">Why Tailwind?</a>
                        </div>
                      </div>
                      <div className="mt-12 xl:mt-0 px-6 flex-shrink-0 hidden md:block">
                        <iframe src="/workflow-animation" className="border-0 mx-auto" style={{width: "40rem", height: "30rem"}}></iframe>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-center bg-repeat-x -mb-8 md:hidden" style={{height: "142.5px", marginTop: "-142.5px", backgroundSize: "3241.5px 142.5px", backgroundImage: "url(/img/tailwind-bg.svg)"}}></div>
                <div className="bg-center bg-repeat-x -mb-8 hidden md:block" style={{height: "190px", marginTop: "-190px", backgroundSize: "4322px 190px", backgroundImage: "url(/img/tailwind-bg.svg)"}}></div>
              </div>
            </div>
            ...
            <div className="w-full max-w-screen-xl mx-auto px-6">
              <div className="lg:flex -mx-6">
                {/* Side nav */}
                <div id="sidebar" className="hidden fixed inset-0 h-full pt-24 bg-gray-100 z-90 w-full border-b -mb-16 lg:-mb-0 lg:static lg:h-auto lg:bg-transparent lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">
                  <div id="navWrapper" className="h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:relative lg:sticky lg:top-0 bg-gray-100 lg:bg-transparent overflow-hidden">
                    <div id="navGradient" className="hidden lg:block h-16 pointer-events-none absolute inset-x-0 z-10" style={{backgroundImage: "linear-gradient(rgba(255,255,255,1), rgba(255,255,255,0))"}}></div>
                    <nav id="nav" className="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-screen">
                      ...
                      <div className="mb-10">
                        <Link href="/docs/installation" passHref>
                          <a href="/docs/installation" className={`flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium ${Config.categoryActive(frontMatter, '/docs') ? 'text-gray-900' : 'text-gray-600' }`}>
                        ...
                        <Link href="/components" passHref>
                          <a href="/components" className={`mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium ${Config.categoryActive(frontMatter, '/components') ? 'text-gray-900' : 'text-gray-600' }`}>
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <Link href="/screencasts" passHref>
                          <a href="/screencasts" data-external className={`mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium ${Config.categoryActive(frontMatter, '/course')  || Config.categoryActive(frontMatter, '/screencasts')? 'text-gray-900' : 'text-gray-600' }`}>
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <Link href="/resources" passHref>
                          <a href="/resources" className={`mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium ${Config.categoryActive(frontMatter, '/resources') ? 'text-gray-900' : 'text-gray-600' }`}>
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <Link href="/community" passHref>
                          <a href="/community" className={`mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium ${Config.categoryActive(frontMatter, '/community') ? 'text-gray-900' : 'text-gray-600' }`}>
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      ...
                      {Object.keys(Config.navigation[Config.categoryName()]).map((sectionName, secidx) => {
                        return (<div key={secidx} className="mb-8">
                          {Config.navigation[Config.categoryName()][sectionName] === '/course/coming-soon' ?
                          ...
                          <ul>
                            {Object.keys(Config.navigation[Config.categoryName()][sectionName]).map((name, docidx) => {
                              return (<li className="mb-3 lg:mb-1" key={docidx}>
                                {Config.navigation[Config.categoryName()][sectionName][name] === '/course/coming-soon' ?
                                    <Link href={Config.navigation[Config.categoryName()][sectionName][name]} passHref>
                                      <a className="px-2 -mx-2 py-1 relative block text-gray-400 font-medium" href={Config.navigation[Config.categoryName()][sectionName][name]}>
                                        <span className={`rounded absolute inset-0 bg-teal-200 ${Config.active(frontMatter, Config.navigation[Config.categoryName()][sectionName][name]) ? 'opacity-25' : 'opacity-0' }`}></span>
                                        <span className="relative">{name}</span>
                                      </a>
                                    </Link> :
                                    <Link href={Config.navigation[Config.categoryName()][sectionName][name]} passHref>
                                      <a className={`px-2 -mx-2 py-1 transition duration-200 ease-in-out relative block ${Config.active(Config.navigation[Config.categoryName()][sectionName][name]) ? 'text-teal-600 font-medium' : 'hover:translate-x-2px hover:text-gray-900 text-gray-600 font-medium' }`} href={Config.navigation[Config.categoryName()][sectionName][name]}>
                                        <span className={`rounded absolute inset-0 bg-teal-200 ${Config.active(frontMatter, Config.navigation[Config.categoryName()][sectionName][name]) ? 'opacity-25' : 'opacity-0' }`}></span>
                                        <span className="relative">{name}</span>
                                      </a>
                                    </Link>}
                ...
                <div id="content-wrapper" className="min-h-screen w-full lg:static lg:max-h-full lg:overflow-visible lg:w-3/4 xl:w-4/5 ">
                  ...
                  <div id="content">
                    ...
                    <div id="app" className="flex">
                      ...
                      {/* Main content area */}
                      <div id="what-is-tailwind" className="pt-12 pb-16 lg:pt-12 w-full">
                        <div className="markdown mb-6 px-6 max-w-3xl mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12 xl:w-3/4">
                          <h1>{frontMatter.title}</h1>

                          {/* <p className="text-gray-600 text-xl leading-snug mt-4">Tailwind is different from frameworks like Bootstrap, Foundation, or Bulma in that it's not a UI kit and doesn't include any built-in UI components.</p> */}
                          ...
                          {frontMatter.titleBorder ? <hr className="my-8 border-b-2 border-gray-200"/> : ''}
                        ...
                        <div className="flex">
                          ...
                          <div className="hidden xl:text-sm xl:block xl:w-1/4 xl:px-6">
                            <div className="flex flex-col justify-between overflow-y-auto sticky top-0 max-h-screen pt-12 pb-4 -mt-12">

                              {/*<table-of-contents className="mb-8"></table-of-contents>*/}

                              <div id="ad"></div>
                              <div id="tailwind-ui-widget">
                                <a href="https://tailwindui.com/?utm_source=tailwindcss&utm_medium=sidebar-widget" className="mt-3 block">
                                  <img src="/img/tailwind-ui-sidebar.png" alt="Tailwind UI"/>
                                </a>
                                <p className="mt-4 text-gray-700">
                                  <a href="https://tailwindui.com/?utm_source=tailwindcss&utm_medium=sidebar-widget" className="text-gray-700">
                                  Beautiful UI components by the creators of Tailwind CSS.
                                  </a>
                                </p>
                                <div className="mt-2">
                                  <a href="https://tailwindui.com/?utm_source=tailwindcss&utm_medium=sidebar-widget" className="text-sm text-gray-800 font-medium hover:underline">
                                    Learn more &rarr;
                                  </a>
                                </div>
                              </div>
                              <div id="tailwind-ui-job-widget" style={{display: "none"}}>
                                <a href="https://jobs.tailwindui.com/full-stack-developer" className="mt-3 block">
                                  <img className="rounded-lg" src="/img/tailwind-ui-hiring.svg" alt="Tailwind UI"/>
                                </a>
                                <p className="mt-4 text-gray-700">
                                  <a href="https://jobs.tailwindui.com/full-stack-developer" className="text-gray-700">
                                    We're hiring a full-stack developer to help us make UI development faster, easier, and a lot more fun.
                                  </a>
                                </p>
                                <div className="mt-2">
                                  <a href="https://jobs.tailwindui.com/full-stack-developer" className="text-sm text-gray-800 font-medium hover:underline">
                                    Learn more and apply &rarr;
                                  </a>
                                </div>
                              </div>
                              <div id="refactoring-ui-widget" style={{display: "none"}}>
                                <a href="https://refactoringui.com/book?utm_source=tailwindcss&utm_medium=sidebar-widget" className="mt-3 block">
                                  <img src="/img/refactoring-ui-book.png" alt=""/>
                                </a>
                                <p className="text-gray-700 text-center">
                                  <a href="https://refactoringui.com/book?utm_source=tailwindcss&utm_medium=sidebar-widget" className="text-gray-700">
                                  Learn UI design, from the creators of Tailwind CSS.
                                  </a>
                                </p>
                                <div className="mt-3 text-center">
                                  <a href="https://refactoringui.com/book?utm_source=tailwindcss&utm_medium=sidebar-widget" className="inline-block px-3 py-2 text-sm bg-indigo-500 text-white font-semibold rounded hover:bg-indigo-600">
                                    Learn more &rarr;
                                  </a>
                                </div>
                              </div>
            ...
            <div className="transition transform fixed z-100 bottom-0 inset-x-0 pb-2 sm:pb-5">
