...
export default function Layout(frontMatter) {
    ...
    return ({children: content}) => {
        const {title, description, featureVersion, features, titleBorder, hideTableOfContents}= frontMatter;
      ...
      useEffect(() => {
        ...
        return (
            ...
            {/* Top nav */}
            <div>
              <DocSearch version={Config.version}/>
              <div id="header">
                      ...
                      <div className="lg:w-1/4 xl:w-1/5 pl-6 pr-6 lg:pr-8">
                        <div className="flex items-center">
                          ...
                          <a href="/" className="block lg:mr-4">
                            <svg className="h-10 w-auto hidden md:block" viewBox="0 0 273 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="flex flex-grow lg:w-3/4 xl:w-4/5">
                        ...
                        <div className="w-full lg:px-6 xl:w-3/4 xl:px-12">
                          <div className="relative">
                            <input id="docsearch" className="transition-colors duration-100 ease-in-out focus:outline-0 border border-transparent focus:bg-white focus:border-gray-300 placeholder-gray-600 rounded-lg bg-gray-200 py-2 pr-4 pl-10 block w-full appearance-none leading-normal" type="text" placeholder="Search the docs (Press &quot;/&quot; to focus)"/>
                        ...
                        <div className="hidden lg:flex lg:items-center lg:justify-between xl:w-1/4 px-6">
                          <div className="relative mr-4">
                            <select className="appearance-none block bg-white pl-2 pr-8 py-1 text-gray-500 font-medium text-base focus:outline-none focus:text-gray-800">
                        ...
                        <div className="markdown mb-6 px-6 max-w-3xl mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12 xl:w-3/4">
                          {title ?
                            <h1 className="flex items-center">
                              {title}
                              {/* <span className="ml-4 text-teal-600 font-semibold text-base">v1.3.0+</span> */}
                              {featureVersion ?
...
function formatPath(p) {
  let _p = p.replace(/docs/, '/docs')
  return _p.replace(/\.mdx$/, '')
}