...
@slot('code')
<div className="bg-gray-400"><span className="mt-8 bg-yellow-200">Target</span></div>
<div className="bg-gray-400"><span className="mr-8 bg-yellow-200">Target</span></div>
<div className="bg-gray-400"><span className="mb-8 bg-yellow-200">Target</span></div>
<div className="bg-gray-400"><span className="ml-8 bg-yellow-200">Target</span></div>
@endslot
@endcomponent
...
@slot('code')
<div className="bg-gray-400"><span className="mx-8 bg-yellow-200">Target</span></div>
@endslot
@endcomponent
...
@slot('code')
<div className="bg-gray-400"><span className="my-8 bg-yellow-200">Target</span></div>
@endslot
@endcomponent
...
@slot('code')
<div className="bg-gray-400"><span className="m-8 bg-yellow-200">Target</span></div>
@endslot
@endcomponent
...
@slot('code')
<div className="bg-gray-400 h-16 w-32"></div>
<div className="-mt-8 bg-yellow-200 mx-auto h-16 w-24 ...">
  -mt-8
</div>
@endslot
@endcomponent
...
<div className="inline-block bg-gray-400">
  <div className="mt-8 bg-yellow-200">Target</div>
</div>
@endslot

@slot('sm')
<div className="inline-block bg-gray-400">
  <div className="mt-8 mr-6 bg-yellow-200">Target</div>
</div>
@endslot

@slot('md')
<div className="inline-block bg-gray-400">
  <div className="mt-8 mr-6 mb-4 bg-yellow-200">Target</div>
</div>
@endslot

@slot('lg')
<div className="inline-block bg-gray-400">
  <div className="mt-8 mr-8 mb-4 ml-2 bg-yellow-200">Target</div>
</div>
@endslot

@slot('xl')
<div className="inline-block bg-gray-400">
  <div className="m-0 bg-yellow-200">Target</div>
</div>
@endslot

@slot('code')
<div className="bg-gray-400 ...">
  <span className="none:mt-8 sm:mr-6 md:mb-4 lg:ml-2 xl:m-0 bg-yellow-200">Target</span>
</div>
@endslot
@endcomponent
