...
@slot('sm')
<div className="h-48 p-6 bg-gray-300">
  <div className="h-24 min-h-0 p-6 bg-gray-400 flex items-center justify-center">
    <span>Target</span>
  </div>
</div>
@endslot
...
@slot('code')
<div className="h-48 ...">
  <div className="h-24 none:min-h-full sm:min-h-0 md:min-h-full lg:min-h-0 xl:min-h-full ...">
    min-h-full
  </div>
</div>
@endslot
