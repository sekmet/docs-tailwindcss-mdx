...
@component('_partials.code-sample')
<div>
  <div className="mb-1 text-sm text-gray-600">row-gap-1</div>
...
<div className="mt-8">
  <div className="mb-1 text-sm text-gray-600">row-gap-2</div>
  <div className="grid grid-cols-2 row-gap-2">
    <div className="text-gray-700 text-center bg-gray-400 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-500 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-500 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-400 h-16"></div>
...
<div className="mt-8">
  <div className="mb-1 text-sm text-gray-600">row-gap-6</div>
  <div className="grid grid-cols-2 row-gap-6">
    <div className="text-gray-700 text-center bg-gray-400 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-500 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-500 h-16"></div>
    <div className="text-gray-700 text-center bg-gray-400 h-16"></div>
...
@slot('code')
<div className="grid row-gap-1 grid-cols-2">
  {/* ... */}
</div>

<div className="grid row-gap-2 grid-cols-2">
  {/* ... */}
</div>

<div className="grid row-gap-6 grid-cols-2">
  {/* ... */}
</div>
@endslot
@endcomponent
...
@component('_partials.code-sample')
<div>
  <div className="mb-1 text-sm text-gray-600">col-gap-1</div>
...
<div className="mt-8">
  <div className="mb-1 text-sm text-gray-600">col-gap-2</div>
...
<div className="mt-8">
  <div className="mb-1 text-sm text-gray-600">col-gap-6</div>
...
@slot('code')
<div className="grid col-gap-1 grid-cols-2">
  {/* ... */}
</div>
...
<div className="grid col-gap-6 grid-cols-2">
  {/* ... */}
</div>
@endslot
@endcomponent
