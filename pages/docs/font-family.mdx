...
<p className="font-system text-lg text-gray-800 text-center">
...
@component('_partials.code-sample')
<p className="font-serif text-lg text-gray-800 text-center">
...
@endslot
@slot('code')
<p className="none:font-sans sm:font-serif md:font-mono lg:font-sans xl:font-serif">
  {/* ... */}
</p>
@endslot
@endcomponent
