...
<button className="transition duration-150 ease-in-out transform hover:scale-125 bg-blue-500 text-white font-bold py-2 px-4 rounded">
  Hover me
</button>
<button className="transition duration-300 ease-in-out transform hover:scale-125 bg-blue-500 text-white font-bold py-2 px-4 rounded">
  Hover me
</button>
<button className="transition duration-700 ease-in-out transform hover:scale-125 bg-blue-500 text-white font-bold py-2 px-4 rounded">
  Hover me
</button>
@slot('code')
<button className="transition duration-150 ease-in-out ...">Hover me</button>
<button className="transition duration-300 ease-in-out ...">Hover me</button>
<button className="transition duration-700 ease-in-out ...">Hover me</button>
@endslot
@endcomponent
