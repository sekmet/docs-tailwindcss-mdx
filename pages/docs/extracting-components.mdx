...
<div className="w-64 mx-auto">
  <img className="rounded" src="https://images.unsplash.com/photo-1452784444945-3f422708fe5e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=512&q=80" alt="Beach"/>
  <div className="mt-2">
    <div>
      <div className="text-xs text-gray-600 uppercase font-bold">Private Villa</div>
...
<div className="vacation-card">
  <img className="vacation-card-image" src="..." alt="Beach in Cancun"/>
...
<pre className="language-html"><code>{/* trim(code) */}</code></pre>
