...
@endslot
@slot('lg')
<div className="h-64 grid grid-rows-5 grid-flow-col gap-4">
  <div className="bg-gray-300 flex items-center justify-center">1</div>
  <div className="bg-gray-500 flex items-center justify-center">2</div>
  <div className="bg-gray-300 flex items-center justify-center">3</div>
  <div className="bg-gray-500 flex items-center justify-center">4</div>
...
@endslot
@slot('xl')
<div className="h-64 grid grid-rows-6 grid-flow-col gap-4">
  <div className="bg-gray-300 flex items-center justify-center">1</div>
  <div className="bg-gray-500 flex items-center justify-center">2</div>
  <div className="bg-gray-300 flex items-center justify-center">3</div>
  <div className="bg-gray-500 flex items-center justify-center">4</div>
...
@endslot
@slot('code')
<div className="grid grid-flow-col none:grid-rows-2 sm:grid-rows-3 md:grid-rows-4 lg:grid-rows-5 xl:grid-rows-6 ...">
  {/* ... */}
</div>
@endslot
@endcomponent
