...
@slot('none')
<div className="grid grid-cols-6 gap-4">
  <div className="col-span-6 bg-gray-500 h-12 flex items-center justify-center"></div>
  <div className="col-span-3 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-3 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-6 bg-gray-500 h-12 flex items-center justify-center"></div>
</div>
...
@slot('sm')
<div className="grid grid-cols-6 gap-4">
  <div className="col-span-4 bg-gray-500 h-12 flex items-center justify-center"></div>
  <div className="col-span-2 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-2 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-4 bg-gray-500 h-12 flex items-center justify-center"></div>
</div>
@endslot
@slot('md')
<div className="grid grid-cols-6 gap-4">
  <div className="col-span-3 bg-gray-500 h-12 flex items-center justify-center"></div>
  <div className="col-span-3 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-3 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-3 bg-gray-500 h-12 flex items-center justify-center"></div>
</div>
...
@slot('lg')
<div className="grid grid-cols-6 gap-4">
  <div className="col-span-5 bg-gray-500 h-12 flex items-center justify-center"></div>
  <div className="col-span-1 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-4 bg-gray-300 h-12 flex items-center justify-center"></div>
  <div className="col-span-2 bg-gray-500 h-12 flex items-center justify-center"></div>
</div>
@endslot
@slot('xl')
...
@slot('code')
<div className="grid grid-cols-6 gap-4">
  <div className="none:col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-5 xl:col-span-2..."></div>
  <div className="none:col-span-3 sm:col-span-2 md:col-span-3 lg:col-span-1 xl:col-span-4..."></div>
  <div className="none:col-span-3 sm:col-span-2 md:col-span-3 lg:col-span-4 xl:col-span-2..."></div>
  <div className="none:col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2 xl:col-span-4..."></div>
</div>
@endslot
@endcomponent
