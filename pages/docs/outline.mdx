...
<input type="text" className="px-2 m-2 outline-none" placeholder="Focus me (no outline)" />
<input type="text" className="px-2 m-2 outline-none focus:shadow-outline focus:bg-blue-100" placeholder="Focus me (custom)" />
@slot('code')
<input type="text"
...
<input type="text"
  ...
  className="outline-none focus:shadow-outline focus:bg-blue-100 ..." />
@endslot
@endcomponent
