    ...
    <table className="w-full text-left table-collapse">
      ...
      <tbody className="align-baseline">
        ...
        <tr>
          ...
          <td className="p-2 border-t {{ $loop->first ? 'border-gray-300' : 'border-gray-200' }} font-mono text-xs text-blue-700 whitespace-pre">--space-x-reverse: 1</td>
        </tr>
        <tr>
          <td className="p-2 border-t {{ $loop->first ? 'border-gray-300' : 'border-gray-200' }} font-mono text-xs text-purple-700 whitespace-no-wrap">
          .space-y-reverse
          ...
          <td className="p-2 border-t {{ $loop->first ? 'border-gray-300' : 'border-gray-200' }} font-mono text-xs text-blue-700 whitespace-pre">--space-y-reverse: 1</td>
        </tr>
      </tbody>
    </table>
  </div>
...
@slot('md')
<div className="flex space-x-6 bg-gray-200">
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">1</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">2</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">3</div>
</div>
...
@slot('lg')
<div className="flex space-x-8 bg-gray-200">
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">1</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">2</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">3</div>
</div>
...
@slot('xl')
<div className="flex space-x-12 bg-gray-200">
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">1</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">2</div>
  <div className="text-gray-700 text-center bg-gray-400 px-4 py-2">3</div>
</div>
...
@slot('code')
<div className="flex none:space-x-2 sm:space-x-4 md:space-x-6 lg:space-x-8 xl:space-x-12">
  <div>1</div>
  <div>2</div>
  <div>3</div>
</div>
