...
<div className="rounded p-4 bg-gray-200 shadow-inner">.shadow-inner</div>
@slot('code')
...
@component('_partials.code-sample', ['class' => 'flex justify-around text-sm py-8'])
<div className="rounded p-4 shadow-none bg-gray-200">.shadow-none</div>
@slot('code')
...
@slot('none')
<div className="h-16 w-16 bg-white rounded shadow"></div>
@endslot
@slot('sm')
<div className="h-16 w-16 bg-white rounded shadow-md"></div>
@endslot
@slot('md')
<div className="h-16 w-16 bg-white rounded shadow-lg"></div>
@endslot
@slot('lg')
<div className="h-16 w-16 bg-white rounded shadow-xl"></div>
@endslot
@slot('xl')
<div className="h-16 w-16 bg-white rounded shadow-2xl"></div>
@endslot
@slot('code')
<div className="none:shadow sm:shadow-md md:shadow-lg lg:shadow-xl xl:shadow-2xl ...">
  {/* ... */}
</div>
@endslot
@endcomponent
