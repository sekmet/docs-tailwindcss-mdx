...
<div className="flex flex-wrap -mx-2 mt-0">
  <div className="px-2 w-full relative">
    <h3 className="markdown no-toc mb-4 mt-8">Black & White</h3>
    <div className="-mx-2 -mt-5 flex flex-wrap">
      <div className="w-1/2 md:w-1/3 px-2">
        <div className="flex items-center mt-5">
          <div className="h-12 w-12 rounded-lg shadow-inner bg-black"></div>
          <div className="ml-2 text-gray-800 text-xs leading-none pl-1">
            <div className="font-semibold">Black</div>
            <div className="mt-1 font-normal opacity-75">#000000</div>
          </div>
        </div>
      </div>
      <div className="w-1/2 md:w-1/3 px-2">
        <div className="flex items-center mt-5">
          <div className="h-12 w-12 rounded-lg shadow-inner bg-white"></div>
          <div className="ml-2 text-gray-800 text-xs leading-none pl-1">
            <div className="font-semibold">White</div>
            <div className="mt-1 font-normal opacity-75">#FFFFFF</div>
          </div>
        </div>
      </div>
    </div>
