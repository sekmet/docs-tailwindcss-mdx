...
<p className="normal-case text-lg text-gray-800">The quick brown fox jumped over the lazy dog.</p>
@slot('code')
...
@component('_partials.code-sample')
<p className="uppercase text-lg text-gray-800">The quick brown fox jumped over the lazy dog.</p>
@slot('code')
...
@component('_partials.code-sample')
<p className="lowercase text-lg text-gray-800">The quick brown fox jumped over the lazy dog.</p>
@slot('code')
...
@component('_partials.code-sample')
<p className="capitalize text-lg text-gray-800">The quick brown fox jumped over the lazy dog.</p>
@slot('code')
...
@endslot
@slot('code')
<p className="none:uppercase sm:lowercase md:capitalize lg:normal-case xl:uppercase ...">
