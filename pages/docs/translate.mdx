...
<img className="h-16 w-16 rounded transform translate-y-6" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
<img className="h-16 w-16 rounded transform -translate-y-6" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
<img className="h-16 w-16 rounded transform translate-y-0" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
@slot('code')
<img className="transform translate-y-6 ..."/>
<img className="transform -translate-y-6 ..."/>
<img className="transform translate-y-0 ..."/>
@endslot
@endcomponent
...
@endslot
@slot('md')
<img className="h-16 w-16 rounded transform translate-y-2" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
@endslot
@slot('lg')
<img className="h-16 w-16 rounded transform -translate-y-8" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
@endslot
@slot('xl')
<img className="h-16 w-16 rounded transform translate-y-0" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"/>
@endslot
@slot('code')
<img className="transform none:translate-y-6 sm:-translate-y-6 md:translate-y-2 lg:-translate-y-8 xl:translate-y-0..."/>
@endslot
@endcomponent
