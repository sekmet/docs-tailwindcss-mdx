...
<div className="flex justify-center">
  ...
  <div className="bg-gray-600 visible"></div>
  <div className="bg-gray-400"></div>
</div>
@endslot
@endcomponent
...
<div className="flex justify-center">
  <div className="bg-gray-400"></div>
  <div className="bg-gray-600 invisible"></div>
  <div className="bg-gray-400"></div>
</div>
@endslot
@endcomponent
...
<div className="flex justify-center">
  <div className="bg-gray-400"></div>
  <div className="bg-gray-600 none:visible sm:invisible md:visible lg:invisible xl:visible"></div>
  <div className="bg-gray-400"></div>
</div>
@endslot
@endcomponent
