...
@slot('sm')
<div className="h-24 p-6 bg-gray-300">
  <div className="h-48 max-h-screen p-6 bg-gray-400 flex items-center justify-center">
    <span>Target</span>
  </div>
</div>
@endslot
...
@slot('code')
<div className="h-24 ...">
  <div className="h-48 none:max-h-full sm:max-h-screen md:max-h-full lg:max-h-screen xl:max-h-full ...">
    <span>Target</span>
  </div>
</div>
@endslot
