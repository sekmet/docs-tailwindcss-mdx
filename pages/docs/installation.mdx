...
<div className="heading mt-0">
  <h2 className="flex markdown mt-0">
...
<div className="heading mt-0">
  <h2 className="flex markdown">
    <span className="text-lg bg-gray-200 text-gray-700 h-6 w-6 rounded-full inline-flex justify-center items-center mt-px mr-3">2</span>
...
<div className="heading mt-0">
  <h2 className="flex markdown">
    <span className="text-lg bg-gray-200 text-gray-700 h-6 w-6 rounded-full inline-flex justify-center items-center mt-px mr-3">3</span>
    <span data-heading-text className="mt-0">Create your Tailwind config file <span className="text-gray-600">(optional)</span></span>
  </h2>
</div>
...
<div className="heading mt-0">
  <h2 className="flex markdown">
    <span className="text-lg bg-gray-200 text-gray-700 h-6 w-6 rounded-full inline-flex justify-center items-center mt-px mr-3">4</span>
...
<ul className="list-none pl-0">
  <li className="flex items-center">
    <svg className="h-6 w-6 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon-close-circle"><circle cx="12" cy="12" r="10" fill="#fed7d7"/><path fill="#f56565" d="M13.41 12l2.83 2.83a1 1 0 0 1-1.41 1.41L12 13.41l-2.83 2.83a1 1 0 1 1-1.41-1.41L10.59 12 7.76 9.17a1 1 0 0 1 1.41-1.41L12 10.59l2.83-2.83a1 1 0 0 1 1.41 1.41L13.41 12z"/></svg>
