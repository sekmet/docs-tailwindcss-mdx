...
<div className="w-auto bg-gray-400 mb-4 px-2">.w-auto on block element</div>
<div className="w-auto inline-block bg-gray-400 px-2">.w-auto on inline-block element</div>
@slot('code')
<div className="w-auto ..."></div>
<div className="w-auto inline-block ..."></div>
@endslot
@endcomponent
...
<div className="flex items-center mb-1">
  <p className="text-sm text-gray-600 w-12 mr-2">.w- $name </p>
  <div className="h-4 bg-gray-400 w- $name "></div>
</div>
@endforeach
@slot('code')
@foreach (collect([0 => '0', 'px' => '1px'])->union($page->config['theme']['spacing']->except(['0', 'px'])) as $name => $width)
...
<div className="bg-gray-400 p-4 text-center">
  <div className="inline-block bg-gray-800 text-white p-2 truncate w-1/2">Responsive Element</div>
</div>
@endslot

@slot('sm')
<div className="bg-gray-400 p-4 text-center">
  <div className="inline-block bg-gray-800 text-white p-2 truncate w-auto">Responsive Element</div>
</div>
@endslot

@slot('md')
<div className="bg-gray-400 p-4 text-center">
  <div className="inline-block bg-gray-800 text-white p-2 truncate w-full">Responsive Element</div>
</div>
@endslot

@slot('lg')
<div className="bg-gray-400 p-4 text-center">
  <div className="inline-block bg-gray-800 text-white p-2 truncate w-32">Responsive Element</div>
</div>
@endslot

@slot('xl')
<div className="bg-gray-400 p-4 text-center">
  <div className="inline-block bg-gray-800 text-white p-2 truncate w-3/4">Responsive Element</div>
</div>
@endslot

@slot('code')
<div className="bg-gray-400 p-4 text-center">
  <div className="none:w-1/2 sm:w-auto md:w-full lg:w-32 xl:w-3/4 ...">
    Responsive Element
  </div>
</div>
@endslot
