...
@slot('none')
<div className="max-w-sm mx-auto text-center p-6 bg-gray-300">
  Target
</div>
@endslot
@slot('sm')
...
@endslot
@slot('md')
<div className="max-w-lg mx-auto text-center p-6 bg-gray-300">
  Target
</div>
@endslot
@slot('lg')
<div className="max-w-xl mx-auto text-center p-6 bg-gray-300">
  Target
</div>
@endslot
@slot('xl')
<div className="max-w-2xl mx-auto text-center p-6 bg-gray-300">
  Target
</div>
@endslot
@slot('code')
<div className="none:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl ...">
  Target
</div>
@endslot
@endcomponent
