...
<button className="transition duration-700 ease-in transform hover:scale-125 bg-blue-500 text-white font-bold py-2 px-4 rounded">
  Hover me
</button>
<button className="transition duration-700 ease-out transform hover:scale-125 bg-blue-500 text-white font-bold py-2 px-4 rounded">
  Hover me
</button>
...
@slot('code')
<button className="transition ease-in duration-700 ...">Hover me</button>
<button className="transition ease-out duration-700 ...">Hover me</button>
<button className="transition ease-in-out duration-700 ...">Hover me</button>
@endslot
@endcomponent
