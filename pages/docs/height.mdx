...
<div className="h-auto w-32 text-center mx-auto bg-gray-400 p-6">h-auto</div>
@slot('code')
<div className="h-auto w-32 p-6 ...">h-auto</div>
@endslot
@endcomponent
...
@slot('md')
<div className="h-16 w-32 bg-gray-400"></div>
@endslot

@slot('lg')
<div className="h-20 w-32 bg-gray-400"></div>
@endslot

@slot('xl')
<div className="h-24 w-32 bg-gray-400"></div>
@endslot

@slot('code')
<div className="none:h-8 sm:h-12 md:h-16 lg:h-20 xl:h-24 w-32 bg-gray-400"></div>
@endslot
@endcomponent
