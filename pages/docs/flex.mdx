...
<p className="text-sm text-gray-600 mb-1">Items don't grow when there's extra space</p>
...
<p className="text-sm text-gray-600 mb-1">Items shrink if possible when needed</p>
...
<p className="text-sm text-gray-600 mb-1">With <code>.flex-1</code></p>
<div className="flex bg-gray-200">
...
<p className="text-sm text-gray-600 mb-1">With <code>.flex-auto</code></p>
<div className="flex bg-gray-200">
...
<div className="flex bg-gray-200">
  ...
  <div className="flex-auto text-gray-800 text-center bg-gray-500 px-4 py-2 m-2">
    Responsive flex item
  </div>
  <div className="flex-1 text-gray-700 text-center bg-gray-400 px-4 py-2 m-2">
    Item that can grow or shrink if needed
...
<div className="flex bg-gray-200">
  ...
  <div className="flex-initial text-gray-800 text-center bg-gray-500 px-4 py-2 m-2">
    Responsive flex item
  </div>
  <div className="flex-1 text-gray-700 text-center bg-gray-400 px-4 py-2 m-2">
    Item that can grow or shrink if needed
...
<div className="flex ...">
  {/* ... */}
  <div className="none:flex-none sm:flex-1 md:flex-auto lg:flex-initial xl:flex-1 ...">
    Responsive flex item
  </div>
  {/* ... */}
</div>
