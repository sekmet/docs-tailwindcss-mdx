...
<form className="flex w-full max-w-sm mx-auto">
  <input className="flex-1 bg-gray-200 hover:bg-white hover:border-gray-300 focus:outline-none focus:bg-white focus:shadow-outline focus:border-gray-300 appearance-none border border-transparent rounded w-full py-2 px-4 text-gray-700 leading-tight " type="email" placeholder="Your email"/>
  <button className="ml-4 flex-shrink-0 bg-teal-500 hover:bg-teal-600 focus:outline-none focus:shadow-outline text-white font-bold py-2 px-4 rounded" type="button">
    Sign Up
  </button>
</form>
{`<form>
...
<button type="button" className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded focus:outline-none focus:shadow-outline">
  Hover me
</button>
...
<div className="max-w-xs w-full mx-auto">
  <input className="bg-gray-200 focus:bg-white border-transparent focus:border-blue-400 text-gray-900 appearance-none inline-block w-full text-gray-900 border rounded py-3 px-4 focus:outline-none" placeholder="Focus me"/>
</div>

{`
<input className="bg-gray-200 focus:bg-white border-transparent focus:border-blue-400 ..." placeholder="Focus me"/>
`}
</CodeSample>
...
<CodeSample className="text-center" lang="html">
<button type="button" className="bg-blue-500 active:bg-blue-700 text-white font-semibold hover:text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
  Click me
</button>

{`
<button className="bg-blue-500 active:bg-blue-700 text-white...">
  Click me
</button>
`}
</CodeSample>
...
<CodeSample className="text-center" lang="html">
<button type="button" className="ml-4 disabled:opacity-75 bg-blue-500 active:bg-blue-700 text-white font-semibold hover:text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
  Submit
</button>
<button disabled type="button" className="ml-4 disabled:opacity-75 bg-blue-500 active:bg-blue-700 text-white font-semibold hover:text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
  Submit
</button>

{`
<button className="disabled:opacity-75 bg-blue-500...">
  Submit
</button>
...
<CodeSample className="text-center" lang="html">
<a href="#" className="underline font-semibold text-blue-600">Unvisited link</a>
<a href="#" className="ml-4 underline font-semibold text-purple-600">Visited link</a>
...
<CodeSample className="text-center" lang="html">
<div className="text-left max-w-sm border rounded">
  <div className="px-4 py-2 border-t first:border-t-0">One</div>
  <div className="px-4 py-2 border-t first:border-t-0">Two</div>
  <div className="px-4 py-2 border-t first:border-t-0">Three</div>
</div>
...
<CodeSample className="text-center" lang="html">
<div className="text-left max-w-sm border rounded">
  <div className="px-4 py-2 border-b last:border-b-0">One</div>
  <div className="px-4 py-2 border-b last:border-b-0">Two</div>
  <div className="px-4 py-2 border-b last:border-b-0">Three</div>
</div>

{`
<div className="border rounded">
  <div v-for="item in items" className="border-b last:border-b-0">
    @ item @@
  </div>
</div>
`}
...
<CodeSample className="text-center" lang="html">
<div className="rounded overflow-hidden text-left max-w-sm border">
  <div className="px-4 py-2 bg-white odd:bg-gray-200">One</div>
  <div className="px-4 py-2 bg-white odd:bg-gray-200">Two</div>
  <div className="px-4 py-2 bg-white odd:bg-gray-200">Three</div>
</div>

{`
<div className="border rounded">
  <div v-for="item in items" className="bg-white odd:bg-gray-200">
    @ item @@
  </div>
</div>
`}
...
<CodeSample className="text-center" lang="html">
<div className="rounded overflow-hidden text-left max-w-sm border">
  <div className="px-4 py-2 bg-white even:bg-gray-200">One</div>
  <div className="px-4 py-2 bg-white even:bg-gray-200">Two</div>
  <div className="px-4 py-2 bg-white even:bg-gray-200">Three</div>
</div>

{`
<div className="border rounded">
  <div v-for="item in items" className="bg-white even:bg-gray-200">
    @ item @@
  </div>
</div>
`}
...
<CodeSample className="bg-gray-200 p-8" lang="html">
<div className="group hover:bg-blue-500 p-4 cursor-pointer bg-white rounded max-w-xs w-full shadow-lg select-none overflow-hidden mx-auto">
  <p className="font-semibold text-lg mb-1 text-gray-900 group-hover:text-white">New Project</p>
  <p className="text-gray-700 group-hover:text-white mb-2">Create a new project from a variety of starting templates.</p>
</div>
...
<CodeSample className="text-center bg-white p-8" lang="html">
<span className="inline-flex rounded-md shadow-sm">
  <button type="button" className="group inline-flex items-center px-4 py-2 border border-gray-400 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-900 focus:outline-none focus:text-gray-900 focus:border-gray-500 hover:border-gray-500">
  <svg fill="currentColor" viewBox="0 0 20 20" className="-ml-1 mr-3 w-5 h-5 text-gray-400 group-focus:text-gray-500"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path></svg>
    Bookmark
  </button>
</span>
...
<div className="text-sm bg-blue-100 text-blue-700 font-semi-bold px-4 py-2 mb-4 rounded">
  <div className="flex items-center">
    ...
    <div>
      <p className="font-semibold">Note that focus-within is not supported in IE or Edge &lt; 79.</p>
    </div>
  </div>
</div>
...
<form className="w-full max-w-sm mx-auto">
  <div className="flex items-center border-b-2 border-gray-400 focus-within:border-teal-500 py-2">
    ...
    <button className="focus:shadow-outline focus:outline-none flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
      Sign Up
    </button>
  </div>
</form>
...
<ResponsiveCodeSample className="text-center">
<NoneScreenSize>
<button className="px-4 py-2 rounded text-white font-bold bg-orange-500 hover:bg-orange-600">Button</button>
</NoneScreenSize>

<SmScreenSize>
<button className="px-4 py-2 rounded text-white font-bold bg-green-500 hover:bg-green-600">Button</button>
</SmScreenSize>

<MdScreenSize>
<button className="px-4 py-2 rounded text-white font-bold bg-red-500 hover:bg-red-600">Button</button>
</MdScreenSize>

<LgScreenSize>
<button className="px-4 py-2 rounded text-white font-bold bg-indigo-500 hover:bg-indigo-600">Button</button>
</LgScreenSize>

<XlScreenSize>
<button className="px-4 py-2 rounded text-white font-bold bg-pink-500 hover:bg-pink-600">Button</button>
</XlScreenSize>
<HighlightCode>
{`
<button className="none:bg-orange-500 none:hover:bg-orange-600 sm:bg-green-500 sm:hover:bg-green-600 md:bg-red-500 md:hover:bg-red-600 lg:bg-indigo-500 lg:hover:bg-indigo-600 xl:bg-pink-500 xl:hover:bg-pink-600 ">
  Button
</button>
`}
</HighlightCode>
