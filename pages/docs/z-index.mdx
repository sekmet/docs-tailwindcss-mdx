...
<div className="relative h-32 text-center">
  <div className="z-40 absolute w-24 h-24 ml-0 mt-0 bg-gray-400 flex justify-center items-center">z-40</div>
...
<div className="z-20 ml-4 mt-4 bg-gray-600">z-20</div>
<div className="z-10 ml-6 mt-6 bg-gray-700">z-10</div>
<div className="z-0 ml-8 mt-8 bg-gray-800">z-0</div>
@endslot
@endcomponent
...
<div className="relative w-full h-32 text-center">
  <div className="z-0 absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center">yellow</div>
...
@slot('sm')
<div className="relative h-32 text-center">
  <div className="z-10 absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center">yellow</div>
  <div className="z-40 absolute w-24 h-24 ml-4 mt-0 bg-gray-400 flex justify-center items-center">z-40</div>
  <div className="z-30 absolute w-24 h-24 ml-6 mt-2 bg-gray-500 flex justify-center items-center">z-30</div>
  <div className="z-20 absolute w-24 h-24 ml-8 mt-4 bg-gray-600 flex justify-center items-center">z-20</div>
  <div className="z-10 absolute w-24 h-24 ml-10 mt-6 bg-gray-700 flex justify-center items-center">z-10</div>
...
@slot('md')
<div className="relative h-32 text-center">
  <div className="z-20 absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center">yellow</div>
  <div className="z-40 absolute w-24 h-24 ml-4 mt-0 bg-gray-400 flex justify-center items-center">z-40</div>
  <div className="z-30 absolute w-24 h-24 ml-6 mt-2 bg-gray-500 flex justify-center items-center">z-30</div>
  <div className="z-20 absolute w-24 h-24 ml-8 mt-4 bg-gray-600 flex justify-center items-center">z-20</div>
  <div className="z-10 absolute w-24 h-24 ml-10 mt-6 bg-gray-700 flex justify-center items-center">z-10</div>
...
@slot('lg')
<div className="relative h-32 text-center">
  <div className="z-30 absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center">yellow</div>
  <div className="z-40 absolute w-24 h-24 ml-4 mt-0 bg-gray-400 flex justify-center items-center">z-40</div>
  <div className="z-30 absolute w-24 h-24 ml-6 mt-2 bg-gray-500 flex justify-center items-center">z-30</div>
  <div className="z-20 absolute w-24 h-24 ml-8 mt-4 bg-gray-600 flex justify-center items-center">z-20</div>
  <div className="z-10 absolute w-24 h-24 ml-10 mt-6 bg-gray-700 flex justify-center items-center">z-10</div>
...
@slot('xl')
<div className="relative h-32 text-center">
  <div className="z-40 absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center">yellow</div>
  <div className="z-40 absolute w-24 h-24 ml-4 mt-0 bg-gray-400 flex justify-center items-center">z-40</div>
  <div className="z-30 absolute w-24 h-24 ml-6 mt-2 bg-gray-500 flex justify-center items-center">z-30</div>
  <div className="z-20 absolute w-24 h-24 ml-8 mt-4 bg-gray-600 flex justify-center items-center">z-20</div>
  <div className="z-10 absolute w-24 h-24 ml-10 mt-6 bg-gray-700 flex justify-center items-center">z-10</div>
...
@endslot
@slot('code')
<div className="none:z-0 sm:z-10 md:z-20 lg:z-30 xl:z-40 bg-yellow-400">yellow</div>
<div className="z-40 ml-4 mt-0 bg-gray-400">z-40</div>
<div className="z-30 ml-6 mt-2 bg-gray-500">z-30</div>
<div className="z-20 ml-8 mt-4 bg-gray-600">z-20</div>
<div className="z-10 ml-10 mt-6 bg-gray-700">z-10</div>
<div className="z-0 ml-12 mt-8 bg-gray-800">z-0</div>
@endslot
@endcomponent
